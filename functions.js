...
function addProcess() {
    ...
    let rowHTML1 = `
                          ...
                          <td class="process-time cpu process-heading d-none" colspan="">CPU</td>
                          <td class="process-btn d-none"><button type="button" class="add-process-btn">+</button></td>
                          <td class="process-btn d-none"><button type="button" class="remove-process-btn">-</button></td>
                      `;
    let rowHTML2 = `
